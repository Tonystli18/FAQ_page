...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "mb-8 flex" }, [
    _c("div", { staticClass: "mr-4" }, [
      _c(
        "span",
        {
          staticClass:
            "border border-solid border-gray-700 rounded-full w-6 h-6 flex items-center justify-center text-xs text-gray-700 font-bold leading-none cursor-pointer",
          on: {
    ...
    _c("div", { staticClass: "leading-loose" }, [
      _c("h3", {
        staticClass:
          "font-bold text-2xl mb-3 text-black leading-none cursor-pointer",
